				...
				<div className="grid md:grid-cols-2 gap-12 items-center">
					...
					<div className="text-center md:text-left space-y-8">
						<h1 className="text-5xl md:text-7xl font-light text-[#3A3A3A] leading-tight">
							CozyTouch
							<span className="block text-[#C47A5A] mt-2">Spa & Wellness</span>
						</h1>
						<p className="text-xl md:text-2xl text-[#77716B] font-light leading-relaxed max-w-xl">
							Experience premium spa and massage services in the comfort of your
							own home. CozyTouch Spa brings skilled therapists and relaxing
							treatments right to your doorstep.
						</p>
						<div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
							<a
								href={CALL_LINK}
								className="bg-[#C47A5A] text-white px-10 py-4 rounded-full text-lg hover:bg-[#B36A4A] hover:shadow-xl transition-all duration-300 shadow-lg inline-block text-center">
								Book Appointment
							</a>
							<a
								href="#services"
								className="bg-transparent border-2 border-[#9DB6A0] text-[#3A3A3A] px-10 py-4 rounded-full text-lg hover:bg-[#9DB6A0] hover:text-white transition-all duration-300 inline-block text-center">
								View Services
							</a>
						</div>
						{/* Stats */}
